...
test.describe('Form Detection', () => {
  ...
  test.describe('Real Google Forms', () => {
    test('should detect form on simple Google Form', async ({ context, page }) => {
    ...
    test('should detect all question types', async ({ context, page }) => {
      ...
      const comprehensiveFormUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSdzCu_VB9ddGldroKayb-aiQJOTblHuBP93nOD_L0CaiVF-ew/viewform';
  ...
  test.describe('Question Extraction', () => {
    ...
    test('should extract options for MCQ questions', async ({ context, page }) => {
      test.skip(true, 'Waiting for test Google Form creation');
